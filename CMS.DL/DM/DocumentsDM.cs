...
namespace CMS.DL.DM
{
    public class DocumentsDM
    {
        ...
        {
            string sql = $"INSERT INTO Documents(Created, CreatedBy, Updated, UpdatedBy, FileName, Data, DataContentType, Size, CaseId, Filepath) VALUES (@Created, @CreatedBy, @Updated, @UpdatedBy, @FileName, @Data, @DataContentType, @Size, @CaseId , @FilePath)";
            return await _dbConnection.ExecuteAsync(sql, new { Created = documents.Created, CreatedBy = documents.CreatedBy, Updated = documents.Updated, UpdatedBy = documents.UpdatedBy, FileName = documents.FileName, Data = documents.Data, DataContentType = documents.DataContentType, Size = documents.Size, CaseId = documents.CaseId, FilePath = documents.FilePath });
        }
        ...
        public async Task<int> DeleteDocumentsAsync(Guid id)
        {
